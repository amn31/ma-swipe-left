 		...
 		<div>
			...
			<li class="collection-swipe" >
				<div class="collection-swipe-left" >
					<div class="row "    >
						<div class="col s4 apropos_field lang">Version</div>
						<div class="col s7 apropos_value">
							
							<span onClick="test(2)"> CLICK ssssss ss ss</span>
							
						</div>
						<div class="col s1">
							<i class="collection-swipe-icon material-icons">chevron_left</i>
						</div>
					</div>
				</div>
				<div class="collection-swipe-right THEME">EXTRACT<span onClick="test(1)"> CLICK </span>  </div>
			</li>
			</ul>
		</div>
...
jQuery.fn.collection_swipe = function(options) {
